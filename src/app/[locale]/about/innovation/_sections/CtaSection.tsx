...
interface Props {
  dict: Dictionary["innovation"]["cta"];
  locale: Locale;
  ctaPrimary: string;
  ctaSecondary: string;
}

export default function CtaSection({ dict, locale, ctaPrimary, ctaSecondary }: Props) {
  return (
    <section
      className="bg-navy"
      ...
      <div className="max-w-7xl mx-auto px-6 py-32 lg:py-40">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Button variant="ghost-dark" href={`/${locale}/contact`} arrow={false}>
              {ctaSecondary}
            </Button>
          </div>
