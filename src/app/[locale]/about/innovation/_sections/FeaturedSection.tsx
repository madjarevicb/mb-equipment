...
import { featured as featuredData } from "@/data/innovation";
...
interface Props {
  dict: Dictionary["innovation"]["featured"];
  data: Dictionary["data"]["innovationFeatured"];
  locale: Locale;
}

export default function FeaturedSection({ dict, data }: Props) {
  /* Merge translated text with static image/alt from data file */
  const featured = featuredData.map((item, i) => ({
    ...item,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            {featured.slice(1).map((item, i) => (
              <AnimatedSection key={i} delay={0.08 + i * 0.06}>
