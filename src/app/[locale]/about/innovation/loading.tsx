    ...
    <div role="status" aria-label="Loading Innovation page" aria-busy="true">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-32 w-full">
          <div className="max-w-2xl space-y-4">
            ...
            <div className="h-14 max-w-lg w-full bg-white/10" />
            <div className="h-6 max-w-xl w-full bg-white/10" />
            <div className="h-20 max-w-xl w-full bg-white/5" />
      ...
      <section className="py-24 lg:py-32 bg-red animate-pulse" aria-hidden="true">
        <div className="max-w-7xl mx-auto px-6">
          <div className="space-y-4 mb-16">
            <div className="h-4 w-36 bg-white/20" />
            <div className="h-10 max-w-sm w-full bg-white/20" />
            <div className="h-5 max-w-lg w-full bg-white/10" />
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 mb-6">
            <div className="lg:col-span-3 bg-navy/10 p-14 min-h-[280px]">
              <div className="space-y-4">
                ...
                <div className="h-20 max-w-md w-full bg-gray-100" />
            ...
            <div className="lg:col-span-2 bg-offwhite border-l-4 border-gray-200 p-12 min-h-[280px]">
              <div className="space-y-4">
                ...
                <div className="h-16 max-w-sm w-full bg-gray-100" />
      ...
      <section className="py-32 lg:py-40 bg-navy animate-pulse" aria-hidden="true">
        <div className="max-w-3xl mx-auto px-6 flex flex-col items-center gap-6">
          ...
          <div className="h-12 max-w-lg w-full bg-white/10" />
