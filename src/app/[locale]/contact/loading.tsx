    ...
    <div role="status" aria-label="Loading Contact page" aria-busy="true">
      ...
      <section className="bg-navy pt-32 pb-24 animate-pulse" aria-hidden="true">
        <div className="max-w-7xl mx-auto px-6">
          ...
          {/* h1 */}
          <div className="h-12 sm:h-14 lg:h-16 w-80 sm:w-[28rem] bg-white/10 mt-4" />
          {/* Subtitle */}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16">
            ...
            <div className="lg:col-span-3">
              ...
              <div className="h-7 w-52 bg-gray-200 mb-8" />

              <div className="space-y-6">
                {/* Name / Email row */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    <div className="h-4 w-20 bg-gray-200 mb-1.5" />
                    <div className="h-12 w-full bg-gray-200" />
                  </div>
                  <div>
                    <div className="h-4 w-14 bg-gray-200 mb-1.5" />
                    <div className="h-12 w-full bg-gray-200" />
                  </div>
                </div>
                ...
                {/* Interest select */}
                <div>
                  <div className="h-4 w-24 bg-gray-200 mb-1.5" />
                  <div className="h-12 w-full bg-gray-200" />
                </div>

                {/* Message textarea */}
                <div>
                  <div className="h-4 w-18 bg-gray-200 mb-1.5" />
                  <div className="h-32 w-full bg-gray-200" />
                </div>

                {/* Helper text */}
                <div className="h-3 w-72 bg-gray-200" />
            ...
            <div className="lg:col-span-2">
              ...
              <div className="space-y-8">
                {/* Belgrade Office */}
                <div>
                  <div className="h-3.5 w-32 bg-gray-200 mb-3" />
                ...
                {/* Contact */}
                <div>
                  <div className="h-3.5 w-20 bg-gray-200 mb-3" />
                  <div className="h-5 w-36 bg-gray-200" />
                  <div className="h-4 w-48 bg-gray-200 mt-1" />
                </div>

                {/* Hours */}
                <div>
                  <div className="h-3.5 w-16 bg-gray-200 mb-3" />
