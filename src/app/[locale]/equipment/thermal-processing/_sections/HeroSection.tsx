  ...
  return (
    ...
    >
      <Image
        ...
        alt="Professional chef working with thermal cooking equipment in a commercial kitchen"
        fill
        priority
        sizes="100vw"
      ...
      >
        <span className="text-white/70 text-xs font-medium uppercase tracking-[0.1em]">{common.authorizedPartnerOf}</span>
        <Image
