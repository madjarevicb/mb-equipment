...
/**
 * Editorial pull-quote break. Single monumental italic line.
 * Factual, brand-aligned, no fake attribution.
 */
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-6 relative">
        {/* Thin column rules (visible only on lg+) */}
        <div
          aria-hidden="true"
        ...
        <div className="grid grid-cols-12 gap-6 relative">
          ...
          >
            ...
            >
              A cooking line is a composition —
            </span>
            <span
            ...
            >
              each piece specified to the plate.
            </span>
          </ScrollReveal>
        </div>
