...
const VALUE_PROPS = [
  {
    ...
    note: "Direct Middleby coverage via Belgrade service.",
  },
  {
    label: "Service",
  ...
  {
    label: "Parts",
    value: "Genuine OEM — Josper / Middleby",
    note: "Authorized supply chain, no substitutions.",
  },
  {
    label: "Commissioning",
    value: "Installed & tuned to spec",
    note: "Flue check, first burn, chef walkthrough.",
  },
];
...
export default function PartnerCta({ locale, dict }: PartnerCtaProps) {
  return (
    <>
      <section
        aria-labelledby="josper-partner"
        ...
        <div className="mx-auto max-w-7xl px-6 relative">
          <div className="grid grid-cols-12 gap-6 lg:gap-10">
            <div className="col-span-12 lg:col-span-8 relative z-10">
              ...
              {/* Value props ledger */}
              <ul
                className="mt-7 lg:mt-8 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4"
              >
