        ...
        <div className="grid grid-cols-12 gap-6 lg:gap-10 mt-6 lg:mt-8 items-start">
          ...
          <div className="col-span-12 lg:col-span-7 relative">
            <figure className="relative">
              ...
              >
                <Image
                  src="/images/houno-lincat/lincat-combislim-110.jpg"
                  alt="Lincat CombiSlim combi steam oven — narrow 513 mm professional unit"
                  fill
                  priority
                  fetchPriority="high"
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(180deg, rgba(10,22,40,0.18) 0%, rgba(10,22,40,0.62) 100%)",
                  }}
                />
                <div
                  aria-hidden="true"
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(201,168,76,0.18) 0%, transparent 55%)",
                  }}
                />
