    ...
    >
      ...
      >
        <div className="max-w-7xl mx-auto px-6 w-full space-y-4">
          ...
          <div className="h-14 max-w-xl w-full bg-white/10" />
          <div className="h-6 max-w-2xl w-full bg-white/5" />
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-7 space-y-3">
              ...
              <div className="h-16 w-full bg-gray-100 mt-4" />
            </div>
      ...
      <section className="py-24 lg:py-32 bg-navy animate-pulse" aria-hidden="true">
        <div className="max-w-7xl mx-auto px-6 text-center space-y-4">
          ...
          <div className="h-16 w-24 bg-white/10 mx-auto" />
          <div className="flex flex-wrap justify-center gap-3 mt-6">
            {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((n) => (
              <div key={n} className="h-10 w-36 bg-white/5" />
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="py-16 lg:py-20 bg-white animate-pulse" aria-hidden="true">
        <div className="max-w-7xl mx-auto px-6 mb-10 space-y-3">
          <div className="h-4 w-36 bg-gray-200" />
          <div className="h-10 w-56 bg-gray-200" />
        </div>
      ...
      <section className="py-16 lg:py-20 bg-navy animate-pulse" aria-hidden="true">
        <div className="max-w-7xl mx-auto px-6 flex justify-center gap-8">
          {[1, 2, 3].map((n) => (
            <div key={n} className="h-6 w-28 bg-white/10" />
          ))}
        </div>
      </section>
      ...
      <section className="py-28 lg:py-36 bg-offwhite animate-pulse" aria-hidden="true">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-4">
          <div className="h-4 w-24 bg-gray-200 mx-auto" />
          <div className="h-10 w-64 bg-gray-200 mx-auto" />
          <div className="h-16 max-w-2xl w-full bg-gray-100 mx-auto" />
