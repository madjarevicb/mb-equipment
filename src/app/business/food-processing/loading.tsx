    ...
    >
      ...
      >
        <div className="max-w-7xl mx-auto px-6 w-full space-y-4">
          <div className="h-4 w-52 bg-white/10" />
      ...
      <section className="py-28 lg:py-36 bg-white animate-pulse" aria-hidden="true">
        <div className="max-w-7xl mx-auto px-6">
          <div className="h-4 w-40 bg-gray-200 mb-6" />
      ...
      <section className="py-28 lg:py-36 bg-navy animate-pulse" aria-hidden="true">
        <div className="max-w-7xl mx-auto px-6 space-y-6">
          ...
          <div className="h-12 w-72 bg-white/10" />
          <div className="h-20 max-w-2xl w-full bg-white/5" />
        </div>
      </section>
      ...
      <section className="py-24 lg:py-32 bg-navy animate-pulse" aria-hidden="true">
        <div className="max-w-7xl mx-auto px-6">
          <div className="h-4 w-24 bg-white/10 mb-3" />
          <div className="h-10 w-48 bg-white/10 mb-14" />
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-5 space-y-4">
              <div className="h-6 w-20 bg-white/10" />
              {[1, 2, 3, 4].map((n) => (
                <div key={n} className="h-4 w-32 bg-white/5" />
              ))}
            </div>
            <div className="lg:col-span-5 space-y-4">
              <div className="h-6 w-20 bg-white/10" />
