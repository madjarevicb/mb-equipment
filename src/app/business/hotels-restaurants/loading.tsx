    ...
    <div role="status" aria-label="Loading Our Brands page" aria-busy="true">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center gap-6">
            ...
            <div className="flex gap-6">
              {[1, 2, 3, 4, 5].map((n) => (
                <div key={n} className="h-4 w-28 bg-gray-100" />
              ))}
            </div>
          </div>
        </div>
      ...
      <section className="py-24 lg:py-32 bg-offwhite animate-pulse" aria-hidden="true">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-16 space-y-4">
            ...
            <div className="h-12 max-w-md w-full bg-gray-200" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-8 space-y-6">
              {[1, 2, 3, 4, 5, 6, 7].map((n) => (
                ...
                >
                  <div className="h-6 w-8 bg-white/10" />
                  <div className="space-y-2 flex-1">
                    <div className="h-5 w-28 bg-white/10" />
      ...
      >
        <div className="max-w-3xl mx-auto px-6 flex flex-col items-center gap-4">
          ...
          <div className="h-5 max-w-md w-full bg-gray-100" />
