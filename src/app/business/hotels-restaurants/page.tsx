...
const brands = [
  ...
  { name: "Blodgett", text: "Blodgett is a leading manufacturer of convection and combi ovens. Operators have trusted Blodgett for consistency and quality for more than 160 years.", category: "Ovens", logo: null },
  { name: "Bloomfield", text: "Bloomfield is known in the beverage industry as a supplier of coffee brewers, tea brewers, hot water machines, coffee warmers, and beverage dispensing equipment.", category: "Beverage", logo: null },
  ...
  { name: "Carter-Hoffmann", text: "Carter-Hoffmann is the industry expert and leader in food holding and transporting solutions. GardenChef Micro Green and Herb Growing cabinets help you present the highest quality dishes.", category: "Holding & Transport", logo: null },
  ...
  { name: "CookTek", text: "CookTek continues to be the leading innovator in induction warming, cooking, and heated delivery systems for commercial kitchens and restaurants.", category: "Induction", logo: null },
  ...
  { name: "Emery Thompson", text: "An industry-leading brand since 1905, Emery Thompson is known for its best-in-class batch freezers and innovation in frozen dessert equipment.", category: "Frozen Dessert", logo: null },
  ...
  { name: "Flavor Burst", text: "Located in Danville, Indiana, Flavor Burst has specialized in developing flavor and candy injection machines for 30 years, offering products and services to over 30 different countries.", category: "Flavor Injection", logo: null },
  ...
  { name: "Globe", text: "Globe's dedication to quality manufacturing, exceptional service, and value is well known. Not only for our broad slicer and mixer selections, but also for our expanded line of countertop grills, fryers, cookers and scales.", category: "Slicers & Mixers", logo: null },
  ...
  { name: "Imperial Range", text: "Imperial has remained a family-owned company whose mission is to be the preferred global supplier of high quality, top value cooking equipment to the foodservice industry.", category: "Ranges", logo: null },
  ...
  { name: "Jade", text: "Home of the best commercial ranges. Jade Range is continuously redefining technology with regard to design, engineering, manufacturing, quality control, and customer-oriented service.", category: "Premium Ranges", logo: null },
  { name: "JoeTap", text: "JoeTap is the leader in on-demand Nitro Cold Brew Coffee dispensing. Whether you are looking for a ready-to-drink solution or post-mix, JoeTap can dispense still or nitro coffee from keg or bag-in-box.", category: "Nitro Coffee", logo: null },
  ...
  { name: "MagiKitch'n", text: "Best in class charbroilers, griddles, refrigerated bases. Quality kitchen equipment since 1942. New refrigerated bases for griddles and charbroilers.", category: "Charbroilers", logo: null },
  ...
  { name: "Marsal", text: "For over 40 years, Marsal has manufactured innovative restaurant equipment, including commercial deck pizza ovens and refrigerated prep tables that have revolutionized the industry.", category: "Pizza Ovens", logo: null },
  ...
  { name: "Southbend", text: "Southbend manufactures heavy-duty commercial cooking equipment, including sectionals, ranges, broilers, convection ovens, counterlines, and steam equipment.", category: "Heavy-Duty Cooking", logo: null },
  ...
  { name: "Star", text: "Star is a leader in innovative, high-quality commercial cooking equipment. Star manufactures griddles, charbroilers, hot plates, sandwich/panini grills, toasters, concession equipment, and more.", category: "Countertop Cooking", logo: null },
  { name: "Starline", text: "Starline is a line of non-carbonated beverage dispensers.", category: "Beverage Dispensers", logo: null },
  { name: "Synesso", text: "Our mission is to build the best espresso machines on the planet.", category: "Espresso Machines", logo: null },
  { name: "Taylor", text: "When it comes to the success of your business, turn to the Taylor Company, an industry leader in foodservice equipment. We manufacture technologically innovative and versatile foodservice equipment.", category: "Foodservice Equipment", logo: null },
  ...
  { name: "U-Line Commercial", text: "U-Line's suite of commercial kitchen refrigeration solutions focus on food safety and preservation. From blast chillers to chef bases, and prep tables to reach-in refrigeration — trusted since 1962.", category: "Commercial Refrigeration", logo: null },
  { name: "Ultrafryer", text: "Ultrafryer has been producing premium-performance gas and electric fryers since 1969.", category: "Premium Fryers", logo: null },
  ...
  { name: "Wild Goose Filling", text: "Two innovative engineers. One ambitious brewer.", category: "Filling Systems", logo: null },
