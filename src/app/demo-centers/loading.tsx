  ...
  return (
    ...
    >
      ...
      <section
        ...
        aria-hidden="true"
      >
        <div className="max-w-7xl mx-auto px-6 pb-28 w-full space-y-4">
      ...
      <section className="py-24 lg:py-32 bg-offwhite animate-pulse" aria-hidden="true">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="h-10 w-64 bg-gray-200 mb-12" />
              ...
              <div key={n} className="grid grid-cols-1 lg:grid-cols-2 gap-0 bg-white overflow-hidden">
                ...
                <div className="p-8 space-y-4">
                  ...
                  <div className="flex gap-2">
                    <div className="h-7 w-24 bg-gray-100" />
                    <div className="h-7 w-28 bg-gray-100" />
                    <div className="h-7 w-32 bg-gray-100" />
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-28 lg:py-36 bg-navy animate-pulse" aria-hidden="true">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-4">
          <div className="h-4 w-20 bg-white/10 mx-auto" />
          <div className="h-10 w-72 bg-white/10 mx-auto" />
          <div className="h-12 w-full max-w-lg bg-white/5 mx-auto" />
