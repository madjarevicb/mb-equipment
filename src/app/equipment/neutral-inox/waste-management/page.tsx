...
const PAGE_TITLE = "IPC Waste Management Stations | MB Equipment Solutions";
const PAGE_DESC =
  "Professional waste management and separation stations for commercial kitchens. IPC waste systems — hygienic, space-efficient, and code-compliant.";
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/equipment/neutral-inox/waste-management" },
  openGraph: {
    title: PAGE_TITLE,
    description: PAGE_DESC,
    url: `${COMPANY.url}/equipment/neutral-inox/waste-management`,
  ...
  "@graph": [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 4, name: "Waste Management", item: `${COMPANY.url}/equipment/neutral-inox/waste-management` },
      ],
    },
  ],
};
          ...
          <AnimatedSection>
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
              <div className="lg:col-span-7">
                <p className="text-text-secondary text-xs font-medium uppercase tracking-[0.3em] mb-6">Waste Management</p>
