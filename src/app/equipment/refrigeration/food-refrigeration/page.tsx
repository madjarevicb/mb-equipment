...
const PAGE_TITLE = "Commercial Food Refrigeration — Reach-in & Undercounter | MB Equipment Solutions";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: PAGE_TITLE,
    description: PAGE_DESC,
    url: `${COMPANY.url}/equipment/refrigeration/food-refrigeration`,
  ...
  "@graph": [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 4, name: "Food Refrigeration", item: `${COMPANY.url}/equipment/refrigeration/food-refrigeration` },
      ],
    },
  ],
};
...
export default function FoodRefrigerationPage() {
  return (
    <>
          ...
          <AnimatedSection>
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
              <div className="lg:col-span-7">
                <p className="text-text-secondary text-xs font-medium uppercase tracking-[0.3em] mb-6">Food Refrigeration</p>
