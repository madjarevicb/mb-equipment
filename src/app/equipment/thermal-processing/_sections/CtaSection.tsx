        ...
        <AnimatedSection>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-end">
            <div className="lg:col-span-7">
              ...
              >
                Specify Your<br />
                <span className="italic font-normal">Cooking Line.</span>
              </h2>
              <p className="text-text-secondary leading-relaxed mb-12 max-w-lg">
                Whether you are planning a new kitchen, upgrading thermal
                equipment, or rolling out across multiple locations — we
