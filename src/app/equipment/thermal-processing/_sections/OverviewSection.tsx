        ...
        <AnimatedSection>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
            <div className="lg:col-span-7">
              ...
              >
                Every Cooking Method,<br />
                <span className="italic font-normal">One Equipment Partner</span>
              </h2>
            </div>
            <div className="lg:col-span-5 flex flex-col justify-end">
              <p className="text-text-secondary leading-relaxed mb-6">
                From gas ranges and induction suites to charcoal grills and combi
                ovens — we specify, supply, and commission thermal cooking
                equipment matched to your menu, volume, and kitchen layout.
              </p>
              <Link
                href="/contact"
