...
const PAGE_TITLE = "Commercial Pasta Cookers — Professional Pasta Stations | MB Equipment Solutions";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: PAGE_TITLE,
    description: PAGE_DESC,
    url: `${COMPANY.url}/equipment/thermal-processing/pasta-cookers`,
  ...
  "@graph": [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 4, name: "Pasta Cookers", item: `${COMPANY.url}/equipment/thermal-processing/pasta-cookers` },
      ],
    },
  ],
};
...
export default function PastaCookersPage() {
  return (
    <>
          ...
          <AnimatedSection>
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
              <div className="lg:col-span-7">
                <p className="text-text-secondary text-xs font-medium uppercase tracking-[0.3em] mb-6">Pasta Cookers</p>
