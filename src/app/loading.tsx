    ...
    <div role="status" aria-label="Loading page" aria-busy="true">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 w-full pb-36 space-y-4">
          <div className="h-12 sm:h-16 lg:h-20 max-w-3xl w-full bg-white/10" />
          <div className="h-10 sm:h-14 lg:h-16 max-w-xl w-full bg-white/10" />
          <div className="h-6 max-w-xl w-full bg-white/5" />
      ...
      <section className="py-16 lg:py-20 bg-white animate-pulse" aria-hidden="true">
        <div className="max-w-7xl mx-auto px-6 mb-10">
          <div className="h-4 w-72 bg-gray-200 mx-auto" />
        </div>
        <div className="flex items-center justify-center gap-20 overflow-hidden px-6">
          {[1, 2, 3, 4, 5, 6, 7].map((n) => (
            <div
              key={n}
              className="flex-shrink-0 h-20 w-36 bg-gray-100"
            />
          ))}
        </div>
      </section>
      ...
      <section className="py-28 lg:py-36 bg-offwhite animate-pulse" aria-hidden="true">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="max-w-2xl space-y-3 mb-16">
            ...
            <div className="h-10 max-w-xl w-full bg-gray-200" />
            <div className="h-8 max-w-md w-full bg-gray-200" />
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-5 space-y-4">
              ...
              <div className="h-24 sm:h-28 lg:h-32 w-64 bg-white/10" />
              <div className="h-6 w-44 bg-white/5" />
              <div className="h-4 w-56 bg-white/5" />
            ...
            <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-8 lg:gap-6 lg:pt-8">
              {[1, 2, 3].map((n) => (
                <div key={n} className="border-l-2 border-white/10 pl-6 space-y-3">
                  ...
                  <div className="h-3 w-36 bg-white/5" />
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-7 space-y-4">
              ...
              <div className="h-4 w-full bg-gray-100 mt-4" />
              <div className="h-4 w-full bg-gray-100" />
              <div className="h-4 w-4/5 bg-gray-100" />
              <div className="h-4 w-full bg-gray-100 mt-4" />
              <div className="h-4 w-full bg-gray-100" />
              <div className="h-4 w-3/4 bg-gray-100" />
              <div className="h-4 w-32 bg-gray-200 mt-4" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-4 space-y-3">
              ...
              <div className="h-10 w-full bg-gray-200" />
              <div className="h-8 w-4/5 bg-gray-200" />
            ...
            <div className="lg:col-span-8 divide-y divide-gray-200">
              {[1, 2, 3, 4, 5, 6].map((n) => (
                <div key={n} className="py-5 flex items-center justify-between">
                  ...
                  />
                  <div className="h-5 w-5 bg-gray-200 flex-shrink-0 ml-4" />
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-4">
              ...
              <div className="h-5 max-w-xl w-full bg-gray-100" />
              <div className="h-4 max-w-lg w-full bg-gray-100" />
            ...
            <div className="lg:col-span-5">
              <div className="bg-navy p-8 lg:p-10 space-y-4">
                ...
                <div className="h-3 w-48 bg-white/5 mt-4" />
              </div>
            </div>
          </div>
        </div>
