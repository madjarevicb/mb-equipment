  ...
  return (
    <Link href={href} className="group relative bg-navy-light/50 overflow-hidden h-full border border-white/5 hover:border-gold/30 focus-visible:outline-gold focus-visible:outline-offset-[-2px] transition-colors duration-500 block">
      <div className="relative h-44 md:h-52 overflow-hidden">
        <Image src={image} alt={alt} fill loading="lazy" className="object-cover group-hover:scale-105 transition-transform duration-700" sizes={sizes} placeholder="blur" blurDataURL="data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNDAwIiBoZWlnaHQ9IjIwOCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48cmVjdCB3aWR0aD0iMTAwJSIgaGVpZ2h0PSIxMDAlIiBmaWxsPSIjMUEyQjRBIi8+PC9zdmc+" />
