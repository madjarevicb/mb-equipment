...
export default function EquipmentCard({ title, image, alt, description, href, sizes, gradient = "red-gold" }: EquipmentCardProps) {
  return (
    <Link href={href} className="group relative bg-navy-light/50 overflow-hidden h-full border border-white/5 hover:border-gold/30 transition-colors duration-500 block">
