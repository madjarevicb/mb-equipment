...
export const equipmentCategories: WhatWeDoItem[] = [
  { title: "Automation", image: "/images/whatwedo/automation.jpg", alt: "Commercial kitchen automation and robotics systems", description: "Robotics saving operators time and costs while producing a consistent product every order, every customer.", href: "/about/innovation" },
  ...
  { title: "Griddling", image: "/images/whatwedo/griddling.jpg", alt: "Taylor double-sided clamshell grill for automated griddling", description: "Automation and griddling together with the Taylor double-sided clamshell grill \u2014 the benchmark in griddling automation.", href: "/business/hotels-restaurants" },
...
export const experienceSpaces: WhatWeDoItem[] = [
  ...
  { title: "Training Room", image: "/images/whatwedo/training-room.jpg", alt: "State-of-the-art 70-person equipment training room", description: "70-person training room with advanced equipment and amenities, protected by Bluezone air purification.", href: "/demo-centers" },
  { title: "Ad Hoc Kitchen", image: "/images/whatwedo/adhoc-kitchen.jpg", alt: "Configurable test kitchen for equipment specification", description: "Design it, build it, test it, tear it down. Configured to help you design, test, and specify the right kitchen.", href: "/demo-centers" },
];
