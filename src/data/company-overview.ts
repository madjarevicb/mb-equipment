...
export const partnershipBlocks: PartnershipBlock[] = [
  {
    ...
    description:
      "Middleby is one of the world\u2019s largest foodservice equipment manufacturers. Our authorization means direct factory engineering support, priority parts supply, and factory access across 110+ brands.",
  },
  {
    number: "02",
