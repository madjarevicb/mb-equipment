...
export const brands: Brand[] = [
  ...
  { name: "Hounö", text: "HOUNÖ Invoq Combi, Hybrid, and Bake ovens, as well as CombiSlim model ovens — the key to unlocking high efficiency and significant cost savings.", category: "Combi Ovens", logo: "/images/brands/houno-logo.png" },
  ...
  { name: "Silko", text: "Since 1980, Silko has stood out for its attention to detail, quality materials, and originality of solutions designed to optimize kitchen productivity.", category: "Cooking Equipment", logo: "/images/brands/silko-logo.png" },
  ...
  { name: "Infrico", text: "INFRICO delivers cooling solutions adapted to specific client needs. Technological excellence, certified quality, and proven reliability.", category: "Refrigeration", logo: "/images/brands/infrico-logo.png" },
  ...
  { name: "Perfect Fry", text: "Perfect Fry commercial ventless fryers are compact, self-contained deep fryers designed to solve common deep-frying challenges.", category: "Ventless Frying", logo: "/images/brands/perfectfry-logo.png" },
  ...
  { name: "Bakers Pride", text: "Founded in the Bronx in the mid-1940s, Bakers Pride initiated one of the most dramatic innovations by inventing the modern production pizza oven.", category: "Pizza Ovens", logo: "/images/brands/bakerspride-logo.png" },
  ...
  { name: "Bluezone", text: "Middleby Bluezone provides advanced air purification technology. Bluezone UV light units destroy 99.9995% of viruses and other indoor contaminants.", category: "Air Purification", logo: null },
  { name: "Britannia", text: "Britannia manufactures and installs commercial and institutional kitchen ventilation solutions — canopies, ventilated ceilings, and extraction systems.", category: "Ventilation", logo: null },
  { name: "Carter-Hoffmann", text: "Carter-Hoffmann is the industry expert and leader in food holding and transport solutions. GardenChef Micro Green and Herb Growing cabinets help you present the highest-quality dishes.", category: "Holding & Transport", logo: "/images/brands/carter-hoffmann-logo.svg" },
  ...
  { name: "Doyon", text: "Whether a retail store, wholesale manufacturer, pizza shop, or artisan bakery, Doyon provides everything needed to complete a baking cycle — from water meters, mixers, proofers, dividers and rounders, sheeters, and ovens, all the way to slicers.", category: "Bakery Equipment", logo: null },
  { name: "Emery Thompson", text: "Manufacturing batch freezers since 1905, Emery Thompson is recognized for its quality and ongoing innovation in frozen dessert equipment.", category: "Frozen Dessert", logo: "/images/brands/emerythompson-logo.png" },
  { name: "Eswood", text: "Eswood is Australia's largest manufacturer of commercial kitchen and foodservice equipment, specializing in durable under-counter dishwashers and glasswashers.", category: "Dishwashing", logo: null },
  ...
  { name: "Goldstein", text: "Goldstein Eswood is the largest manufacturer of commercial kitchen and food service equipment in Australia. The extensive range of Australian-designed products caters to all kitchen sizes and menu requirements.", category: "Commercial Cooking", logo: null },
  ...
  { name: "Kloppenberg", text: "Kloppenberg has supplied commercial ice solutions for more than 80 years and provides an exceptional line of products to a myriad of industries, including healthcare, recreation, oil and gas, agriculture, construction, marine, hospitality, and foodservice.", category: "Ice Solutions", logo: null },
  ...
  { name: "MagiKitch'n", text: "Charbroilers, griddles, and refrigerated bases. Quality kitchen equipment manufactured since 1942, with new refrigerated bases engineered for griddles and charbroilers.", category: "Charbroilers", logo: "/images/brands/magikitchn-logo.svg" },
  ...
  { name: "Nu-Vu", text: "NU-VU, the leader in on-premise baking, manufactures a complete line of oven/proofers, ovens, proofers, carts, and racks designed to complete any baking cycle.", category: "On-Premise Baking", logo: null },
  ...
  { name: "QualServ", text: "QualServ Solutions, a Middleby Corporation company, is a US-based manufacturer providing innovative services, products, comprehensive design, and turnkey solutions with a global supply chain team.", category: "Turn-Key Solutions", logo: null },
